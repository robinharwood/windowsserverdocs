...
- You can also use the [New-ADUser](https://technet.microsoft.com/library/hh852238) Windows PowerShell® cmdlet to add a domain user account.
- Depending upon your Active Directory Domain Service (AD DS) configuration, you may be able to implement a Managed Service Account or Group Managed Service Account for NDES. For more information about Managed Service Accounts, see [Managed Service Accounts](https://technet.microsoft.com/library/ff641731.aspx). For more information about Group Managed Service Accounts, see [Group Managed Service Accounts Overview](/hh831782(v=ws.11).md).
